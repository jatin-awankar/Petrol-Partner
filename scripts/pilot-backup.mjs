...
try {
  ...
  await s3.send(new PutObjectCommand({ Bucket: process.env.PILOT_BACKUP_B2_BUCKET, Key: metadataKey, Body: JSON.stringify({ ...metadata, versionId: uploaded.VersionId }), ContentType: 'application/json', ServerSideEncryption: 'AES256' }));
