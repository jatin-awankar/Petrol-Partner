...
export const operatorSql = {
  ...
  insertPauseAudit: "INSERT INTO pilot_pause_audit (operation_id, operator_id, capability, paused, reason, recorded_at) VALUES ($1, $2, $3, $4, $5, $6)",
  ...
  pendingPauseOperations: "SELECT id, operator_id, capability, paused, state, committed_at FROM pilot_pause_operations WHERE state IN ('intent', 'committed') ORDER BY id",
  restorePauseOperation: `INSERT INTO pilot_pause_operations (id, operator_id, idempotency_key, payload_digest, capability, paused, reason, state, committed_at, acknowledged_at)
            VALUES ($1, $2, $3, $4, $5, $6, $7, 'recovered', $8, now())`,
  markPauseRecovered: "UPDATE pilot_pause_operations SET state = 'recovered', committed_at = $2, acknowledged_at = now() WHERE id = $1",
  restorePauseAudit: "INSERT INTO pilot_pause_audit (operation_id, operator_id, capability, paused, reason, recorded_at) VALUES ($1, $2, $3, $4, $5, $6) ON CONFLICT DO NOTHING",
